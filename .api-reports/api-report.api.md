...
//
// @public (undocumented)
export type PreloadQueryOptions<TVariables extends OperationVariables = OperationVariables, TContext extends DefaultContext = Partial<DefaultContext>> = {
    canonizeResults?: boolean;
    context?: TContext;
    errorPolicy?: ErrorPolicy;
